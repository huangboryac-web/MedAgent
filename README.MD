...
![MedAgent Demo 1](./assets/example1.png)
...
- **Incomplete Path:** If the user says "I feel pain," the router directs to a **Clarifier node** to ask for location, severity, and duration.
...
| **LLM Providers** | Ollama, OpenAI, Vertex AI                     |
...
- LLM Providers (any one only) - Ollama, Vertex AI, OpenAI
...
- For now I have provided only three LLM providers: Ollama, Vertex AI and Open AI.
