...
The agent uses LangGraph for the workflow:
...
3. **Output**: Response with disclaimer if needed.
...
graph TD
    ...
    style Knowledge_Engine fill:#f5f5f5,stroke:#999,stroke-dasharray: 5 5
```
